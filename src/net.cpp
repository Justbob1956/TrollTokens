...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("TrollTokens-ext-ip");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "TrollTokens " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("TrollTokens-dnsseed");
...
unsigned int pnSeed[] =
{
//below are seed node IP numbers converted to hex	
//	0x4475046F,
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("TrollTokens-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("TrollTokens-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("TrollTokens-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. TrollTokens is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("TrollTokens-start");
